...
$sql = "SELECT * FROM products JOIN farmers ON products.farmer_id = farmers.farmer_id ORDER BY product_id DESC LIMIT 5";
...
<a href="products.php" class="text-center">View All</a>
